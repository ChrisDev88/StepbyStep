 ...
 **/
public abstract class Any_as_com_sap_stepbystep_ESPM_Address {
    /**
     ...
     **/
    public static @android.support.annotation.NonNull @org.jetbrains.annotations.NotNull com.sap.stepbystep.ESPM.Address cast(final @android.support.annotation.Nullable @org.jetbrains.annotations.Nullable Object value) {
        if (value instanceof com.sap.stepbystep.ESPM.Address) {
            final com.sap.stepbystep.ESPM.Address var_value = ((com.sap.stepbystep.ESPM.Address)value);
            return var_value;
        } else {
